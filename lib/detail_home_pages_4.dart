...
class DetailHomeEmpatPages extends StatefulWidget {
  const DetailHomeEmpatPages({Key? key}) : super(key: key);

  @override
  State<DetailHomeEmpatPages> createState() => _DetailHomeEmpatPagesState();
}

class _DetailHomeEmpatPagesState extends State<DetailHomeEmpatPages> {
  @override
